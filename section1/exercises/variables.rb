...
# first_name: I used string since my name should be in text
# is_hungry: boolean because it is a true or false binary answer
# number_of_pets: I used a number since the answer should be a intiger
...
healthy_snacks = 6;
junk_food_snacks = 8;
p "total snacks #{healthy_snacks + junk_food_snacks}"
